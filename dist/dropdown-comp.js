...
require("./js/countrySelect.js");

require("./css/countrySelect.css");
...
var CountryDropdown = /*#__PURE__*/function (_React$Component) {
  _inherits(CountryDropdown, _React$Component);

  var _super = _createSuper(CountryDropdown);
  ...
  _createClass(CountryDropdown, [{
    ...
    value: function componentDidMount() {
      ...
      (0, _jquery.default)(this.el).change(function () {
